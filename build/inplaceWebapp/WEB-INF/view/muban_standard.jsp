...
<script type="text/javascript">
	$(function(){
		...
		$('#m-s').datagrid({
			...
			url:'${pageContext.request.contextPath}/json/standard_muban.json',//要改为一个action
				 ...
				 $.post("",null,function(result){
				 		if(result=="fail"){
				 			...
				 			parent.$('#child-win').window({
				 				...
				 				title:'添加',
				 				cache:false,
				 				content:'<iframe src="${pageContext.request.contextPath}/muban_standard_add" frameborder="0" width="100%" height="100%"/>'
				 			});
				 		}
				 	},"text");
				}
			...
			columns:[[
				...
				{field:'number',title:'指标编号',width:100},
				{field:'name',title:'指标名称',width:200,formatter:function(value,row,index){
